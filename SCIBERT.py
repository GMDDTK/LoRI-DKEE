...
def main():
    ...
    parser.add_argument("--model_name_or_path", default=r"G:\pretrain_models\scibert_scivocab_uncased",
                        help="SciBERT 本地目录，例如 G:\\pretrain_models\\scibert_scivocab_uncased")
    parser.add_argument("--save_dir", default="./ckpt_scibert")
    ...
    best_f1 = -1.0
    bad_epochs = 0
    best_dir = os.path.join(args.save_dir, "scibert_best")
