...
def main():
    ...
    parser.add_argument("--model_name_or_path", default=r"G:\pretrain_models\albert-base-v2",
                        help="ALBERT 本地目录，例如 G:\\pretrain_models\\albert-base-v2")
    parser.add_argument("--save_dir", default="./ckpt_albert")
    parser.add_argument("--max_length", type=int, default=128)
    parser.add_argument("--batch_size", type=int, default=32)  # ALBERT 小很多，可以用更大 batch
    ...
    # 加载 ALBERT tokenizer（依赖 spiece.model）
    ...
    best_f1 = -1.0
    bad_epochs = 0
    best_dir = os.path.join(args.save_dir, "albert_best")
